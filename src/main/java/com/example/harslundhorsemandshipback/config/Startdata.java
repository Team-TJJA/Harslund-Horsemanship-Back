...
public class Startdata implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        practiceService.createPractice(practice1);
        ...
        practiceService.createPractice(practice2);
        ...
        practiceService.createPractice(practice3);
        ...
        practiceService.createPractice(practice4);
        ...
        practiceService.createPractice(practice5);
